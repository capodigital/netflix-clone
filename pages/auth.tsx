        ...
        className="relative h-full w-full bg-[url('/images/hero.jpg')] bg-no-repeat bg-center bg-fixed bg-cover">
            <div className="bg-black w-full h-full lg:bg-opacity-50">
                ...
                <div className="flex justify-center">
                    <div className="bg-black bg-opacity-70 px-16 py-16 self-center mt-1 lg:w-2/5 
                       ...
                       <h2 className="text-white text-4xl mb-8 font-semibold">
                        ...
                        <div className="text-white flex flex-col gap-4">
                            ...
                            <div className="flex flex-row items-center gap-4 mt-8 justify-center">
                                <div 
                                className="w-10 h-18 bg-white rounded-full flex items-center 
                                justify-center cursor-pointer hover:opacity-80 transition">
                                    <FcGoogle size={30}/>
                                </div>
                                <div
                                onClick={() => signIn('github', {callbackUrl: '/profiles'})} 
                                className="w-10 h-18 bg-black rounded-full flex items-center 
                                justify-center cursor-pointer hover:opacity-80 transition">
                                    <FaGithub size={30}/>
                                </div>
                            </div>
